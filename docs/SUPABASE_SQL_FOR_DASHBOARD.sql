-- Helper: create exec_sql
-- Copy this SQL into Supabase Dashboard -> SQL editor and Run (service_role rights required)
...
-- =====================================================
-- Core e-commerce schema (from supabase/migrations/20250815_core_schema.sql)
-- Copy entire block below into Supabase SQL editor and Run
-- =====================================================
