      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="group hover:shadow-lg transition-all duration-300 border-0 shadow-md burgundy-shadow"
            >
              <CardContent className="p-8 text-center">
                {/* Icon */}
                <div className="w-16 h-16 bg-accent rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-primary transition-colors duration-300">
                ...
                {feature.stats && (
                  <div className="border-t border-gray-100 pt-6">
                    <div className="text-3xl font-bold text-primary mb-2">{feature.stats.value}</div>
        ...
        <div className="text-center mt-16">
          <div className="bg-burgundy-gradient rounded-2xl p-8 lg:p-12 text-white">
