...
import { calculateSubtotal, calculateTax, calculateTotal, formatCurrency, type MoneyLineItem } from "@/lib/money"
                  ...
                  <div key={item.id} className="flex justify-between items-start p-4 border rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-lg">
                        {formatCurrency(calculateSubtotal([{ quantity: item.quantity, price: item.unitPrice ?? 0 }]))}
                      </p>
                    </div>
                  </div>
                ))}
