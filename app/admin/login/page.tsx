      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="font-semibold text-blue-900 mb-2">ข้อมูลสำหรับทดสอบ:</h4>
            <p className="text-sm text-blue-700">อีเมล: admin@sofacover.com</p>
            <p className="text-sm text-blue-700">รหัสผ่าน: admin123</p>
          </div>
        </CardContent>
      </Card>
    </div>
